...
test('generations()', t => {
  ...
  t.is(devices.generations().length, 94);
...
test('anumbers()', t => {
  ...
  t.is(devices.anumbers().length, 287);
...
test('fccids()', t => {
  ...
  t.is(devices.fccids().length, 194);
...
test('internalNames()', t => {
  ...
  t.is(devices.internalNames().length, 174);
...
test('identifiers()', t => {
  ...
  t.is(devices.identifiers().length, 166);
